...
public class Export {
    ...
    private static void exportExample() throws SVNException {
        ...
        SVNURL url = SVNURL.parseURIEncoded("svn://10.253.248.71/hlicp/trunk");
        String userName = "1073271";
        String userPassword = "1073271";

        /*
         * Prepare filesystem directory (export destination).
         */
        File exportDir = new File("C:/data/export");
        if (exportDir.exists()) {
    ...
    private static class ExportEditor implements ISVNEditor {
        ...
        public void addDir(String path, String copyFromPath, long copyFromRevision) throws SVNException {
        	...
        	if( temp.startsWith("hlicp") &&  ( temp.endsWith("olt") || temp.endsWith("lib") ||  temp.endsWith("bat"))) {
